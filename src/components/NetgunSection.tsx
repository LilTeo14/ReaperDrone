...
export default function NetgunSection({ lang }: NetgunSectionProps) {
  ...
  return (
    <section className="relative bg-[#090b0e] py-24 border-b border-[#242a35]/40" id="netgun-r1">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-7 space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border border-[#242a35] bg-black/25 p-4 rounded-sm">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center items-center relative glass-panel rounded-sm p-8 scanlines min-h-[380px]">
            ...
            <div className="relative w-full max-w-[340px] aspect-square transition-transform hover:scale-102 duration-500 flex items-center justify-center">
              ...
              {(!loaded || failed) && (
                <div className="absolute inset-0 flex flex-col items-center justify-center p-4 text-center font-mono bg-[#0d0f12] z-0">
            ...
            <div className="w-full mt-6 text-center border-t border-[#242a35] pt-4 font-mono text-[9px] text-[#5e7a5e]">
