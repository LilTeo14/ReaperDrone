  ...
  const programs: Record<'en' | 'es', Program[]> = {
    ...
    es: [
      ...
      },
      {
        id: "prog-2",
        code: "02",
        title: "OPERACIÓN DE SISTEMAS VTOL",
            ...
            >
              ...
              <div>
                ...
                <div className="flex justify-between items-center mb-4">
                  <span className="text-[12px] font-mono text-[#ff8f3d] font-bold tracking-wider uppercase">
                ...
                {/* Card Title */}
                <h3 className="text-base font-bold font-mono text-white tracking-wider mb-3 min-h-[40px] flex items-center">
                  {prog.title}
                </h3>
                ...
                {/* Card Description */}
                <p className="text-[13.5px] text-[#8a99ad] leading-relaxed mb-6 font-sans min-h-[72px]">
                  {prog.description}
                </p>
              </div>
              ...
              {/* Card Topics list */}
              <div>
                <h4 className="text-[11px] font-mono text-white/40 tracking-wider uppercase mb-3 flex items-center space-x-1">
                  <Terminal className="w-3.5 h-3.5 text-[#ff6b00]/50" />
                  <span>{t[lang].topicsTitle}</span>
                </h4>
                <ul className="space-y-1.5 font-mono text-[12px] text-white/80">
